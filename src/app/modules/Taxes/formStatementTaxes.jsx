...
function FormStatementTaxes({ step }) {
    ...
    let seleccionado = Number(selConcepto);
    ...
    const showSustitutiva = () => {

        console.log('5555 ', declaracionSeleccionada);
        /*
        if(declaracionsustitutiva) {
            declaraciones.push(initialValuesDeclaration);
            declaraciones.push(declaracionSeleccionada);
        }*/
    }
                                                            ...
                                                            <Row className="mt-4 mb-4">
                                                                ...
                                                                { seleccionado === 2 &&
                                                                    <Col xs="12" sm="6" md="6" lg="6" xl="6" xxl="6" className="mb-6">
                                                                        <label htmlFor="ntrabajadores" className="font-weight-bold">Cantidad trabajadores líquidados</label>
                                                                        <Field
                                                                ...
                                                                <Col xs="12" sm="6" md="6" lg="6" xl="6" xxl="6" className="mb-6">
                                                                    <label htmlFor="monto_pagado" className="font-weight-bold">
                                                                        { seleccionado !== 2 ? 'Pago nómina trimestral' : 'Total Aguinaldos / Utilidades' }
                                                                    </label>
                                                                    <Field
                                                                        id="monto_pagado"
                                                                ...
                                                                { seleccionado === 2 &&
                                                                    <Col xs="12" sm="6" md="6" lg="6" xl="6" xxl="6"
                                                                         className="mb-6">
                                                                        <label htmlFor="fecha_emision" className="font-weight-bold">Fecha de emisión de orden de pago</label>
                                                                        <Field
                                                                            id="fecha_emision"
