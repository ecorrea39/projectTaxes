...
import {Row, Col, Card, Container, Form, Button, Dropdown, DropdownButton} from "react-bootstrap";
...
const UserDatos = (props) => {
  ...
  const customHandleChangeNumeroPatronal = (event) => {
    const value = event.currentTarget.value;

    if (value === '') {
      formik.setFieldValue('numeroPatronal', value);
    } else {
                  ...
                  <Col md={6}>
                    <Form.Group as={Col} controlId="numeroPatronal">
                      <Form.Control size="lg" type="text" placeholder="Número Patronal"
                                    onChange={customHandleChangeNumeroPatronal}
                                    onBlur={formik.handleBlur}
