...
export const BaseFormikMotivoSancion = ({formik, props}) => {
    ...
    useEffect(() => {
        if(props.accion === 'Modificar') {
            ...
            formik.setFieldValue("nveces_mmv", registroSeleccionado.nveces_mmv);
        }
    },[]);
    ...
    return (
        <>
            ...
            <Row className="mt-4 mb-8">
                <Col xs="12" sm="12" md="12" lg="12" xl="12" xxl="12">
                    <label htmlFor="name" className="font-weight-bold">Número veces mmv</label>
                    <Field
                        id="nveces_mmv"
                        name="nveces_mmv"
                        component={BaseInput}
