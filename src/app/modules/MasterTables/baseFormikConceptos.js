...
export const BaseFormikConceptos = ({formik, props}) => {
    ...
    useEffect(() => {
        if(props.accion === 'Modificar') {
            ...
            formik.setFieldValue("clave", registroSeleccionado.clave);
        }
    },[]);
    ...
    return (
        <>
            ...
            <Row className="mt-4 mb-8">
                <Col xs="12" sm="12" md="12" lg="12" xl="12" xxl="12">
                    <label htmlFor="name" className="font-weight-bold">Clave</label>
                    <Field
                        id="clave"
                        name="clave"
                        component={BaseInput}
