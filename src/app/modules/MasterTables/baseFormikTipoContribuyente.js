...
export const BaseFormikTipoContribuyente = ({formik, props}) => {
        ...
        <>
            <Row className="mb-4">
                <Col xs="12" sm="12" md="12" lg="12" xl="12" xxl="12" className="mb-4">
                    <label htmlFor="name" className="font-weight-bold">Código</label>
                    <Field
                        id="name"
                        name="name"
                        component={BaseInput}
                ...
                <Col xs="12" sm="12" md="12" lg="12" xl="12" xxl="12" className="mb-4">
                    <label htmlFor="codigo" className="font-weight-bold">Descripción</label>
                    <Field
                        id="descripcion"
                        name="descripcion"
                        component={BaseInput}
